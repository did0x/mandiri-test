package co.saputra.mandiritest.arch.paging
...
class TopRatedMoviePagingSource(private val api: Api, private val genresMovie: ArrayList<Genre>?) : PagingSource<Int, Movie>() {
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Movie> {
        val pageNumber = params.key ?: 1
        return try {
            val response = api.getTopRatedMovies(BuildConfig.API_KEY, pageNumber)
